...
{
    public class PropertyPage_Aperture : ObjectPropertiesPage
    {
        private PropertyPanel panelUI;
        public override object PageControl => panelUI ?? (panelUI = new PropertyPanel());

        public override string EnglishPageTitle => "HBAperture";
        ...
        public override void UpdatePage(ObjectPropertiesPageEventArgs e)
        {
            ...
            if (this._HBObjEntity is ApertureEntity apt)
            {
                this.panelUI.updateAperturePanel(apt);
            }
        }
    }
